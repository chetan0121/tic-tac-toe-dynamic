...
function SettingsPanel({ panelRef, isOpen, onClose }: SettingsPanelProps) {
  return (
    <div
      className={`fixed top-0 left-0 z-50 flex h-full w-80 max-w-[85vw] flex-col border-r border-white/10 bg-linear-to-b from-[hsl(34,34%,16%)] to-[hsl(18,36%,9%)] shadow-2xl backdrop-blur-xl transition-transform duration-500 ease-in-out will-change-transform ${
